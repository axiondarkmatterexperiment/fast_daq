...
#define check_return_code_macro( function, ... ) \
    ats9462_digitizer_idler::check_return_code( function(__VA_ARGS__), STRINGIFY(function), __FILE_LINE__ );
...
namespace fast_daq
{
    ...
    */
    class ats9462_digitizer_idler : public midge::_producer< midge::type_list< real_time_data > >, public sandfly::control_access
    {
        public:
        ...
        public:
            ats9462_digitizer_idler();
            virtual ~ats9462_digitizer_idler();
    ...
    inline uint32_t ats9462_digitizer_idler::reference_source_to_uint( reference_source_t a_reference_source )
    {
        return static_cast< uint32_t >( a_reference_source );
    }
    inline ats9462_digitizer_idler::reference_source_t ats9462_digitizer_idler::uint_to_reference_source( uint32_t a_reference_source_uint )
    {
        return static_cast< ats9462_digitizer_idler::reference_source_t >( a_reference_source_uint );
    }
    inline void ats9462_digitizer_idler::set_reference_source_and_decimation( const std::string& a_reference_source, U32 a_decimation_factor )
    {
        set_reference_source_and_decimation( string_to_reference_source( a_reference_source ), a_decimation_factor );
    }
    inline std::string ats9462_digitizer_idler::get_reference_source_str() const
    {
        return reference_source_to_string( f_reference_source );
    }

    class ats9462_digitizer_idler_binding : public sandfly::_node_binding< ats9462_digitizer_idler, ats9462_digitizer_idler_binding >
    {
        public:
            ats9462_digitizer_idler_binding();
            virtual ~ats9462_digitizer_idler_binding();

        private:
            virtual void do_apply_config(ats9462_digitizer_idler* a_node, const scarab::param_node& a_config ) const;
            virtual void do_dump_config( const ats9462_digitizer_idler* a_node, scarab::param_node& a_config ) const;
    };

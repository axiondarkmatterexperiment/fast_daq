...
namespace fast_daq
{
    ...
    {
         float units_factor = f_dynamic_range / 65536.;
         float min_volts = f_dynamic_range / 2.0;
         for (unsigned i_bin=0; i_bin<f_array_size; ++i_bin)
         {
            ...
            f_volts_data[i_bin] = (static_cast<float>(f_time_series[i_bin]) * units_factor) - min_volts;
         }
         return f_volts_data;
    }
} /* namespace fast_daq */
